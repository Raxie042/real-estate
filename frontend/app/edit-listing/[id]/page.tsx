...
export default function EditListingPage() {
  ...
  const { data: listing, isLoading } = useQuery<ListingDetails>({
    ...
    queryFn: () => api.listings.getById(listingId).then((res) => res.data),
    enabled: !!listingId,
  });
  ...
  useEffect(() => {
    ...
    setFormData({
      ...
      propertySubType: listing.propertySubType || 'HOUSE',
      ...
      <ProtectedRoute>
        <div className="min-h-screen py-12">
          <div className="max-w-4xl mx-auto px-4 text-center">
            <p className="text-[#7A6E60]">Loading...</p>
          </div>
        </div>
      </ProtectedRoute>
    );
      ...
      <nav className="bg-white/70 backdrop-blur border-b border-[#E8E1D7]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center space-x-2 text-sm">
            <Link href="/my-listings" className="text-[#9A8B7A] hover:text-[#B78F4A]">
              My Listings
            </Link>
            <ChevronRight className="w-4 h-4 text-gray-400" />
            <span className="text-[#1C1A17] font-medium">Edit Property</span>
          </div>
        </div>
      </nav>
        ...
        <div className="lux-card p-8 lux-form">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-2xl font-semibold text-[#1C1A17]">Edit Your Property</h2>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="mt-3">
                  ...
                  >
                    {isGeneratingDescription ? 'Generating...' : 'Regenerate with AI'}
                  </button>
                </div>
              </div>
          ...
          <div className="mt-8 flex justify-between">
            ...
            {step < 4 ? (
              ...
              <button
                ...
                className="lux-button-dark disabled:opacity-50"
              >
